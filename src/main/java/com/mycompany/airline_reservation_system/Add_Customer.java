...
public class Add_Customer extends javax.swing.JInternalFrame {
    ...
    public void autoId()
    {
        try {
           ...
           // Class.forName("com.mysql.cj.jdbc.Driver"); // New driver class
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost/airline_project","root","Ankku@123");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            con=DriverManager.getConnection("jdbc:mysql://localhost/airline_project","root","Ankku@123");
            pre=con.prepareStatement("insert into Customer(Customer_ID,FirstName,LastName,Passport,NationalID,Address,Contact,Gender,DOB)values(?,?,?,?,?,?,?,?,?)");
            pre.setString(1, id);
